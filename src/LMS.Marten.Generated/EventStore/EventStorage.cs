...
namespace Marten.Generated.EventStore
{
    ...
    public class GeneratedEventDocumentStorage : Marten.Events.EventDocumentStorage
    {
        ...
        {
            return new Marten.Generated.EventStore.GeneratedStreamStateQueryHandler(stream.Id, stream.TenantId);
        }
    ...
    public class GeneratedStreamStateQueryHandler : Marten.Events.Querying.StreamStateQueryHandler
    {
        ...
        public GeneratedStreamStateQueryHandler(System.Guid streamId, string tenantId)
        {
            _streamId = streamId;
            _tenantId = tenantId;
        }
